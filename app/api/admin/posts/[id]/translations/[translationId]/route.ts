...
import {
  PostTranslationsService,
  PostTranslationData,
} from '@/src/lib/database/services/posts';
...
export async function GET(
  ...
  try {
    ...
    const translation = await PostTranslationsService.getPostTranslation(
      postId,
      languageCode
    );
    ...
    console.error(
      '❌ Error in GET /api/admin/posts/[id]/translations/[translationId]:',
      error
    );
    return NextResponse.json(
      {
...
export async function PUT(
  ...
  try {
    ...
    const existingTranslation = await PostTranslationsService.getPostTranslation(
      postId,
      languageCode
    );
    ...
    const translationData: PostTranslationData = {
      ...
      metaTitle:
        body.metaTitle !== undefined ? body.metaTitle : existingTranslation.metaTitle,
      metaDescription:
        body.metaDescription !== undefined
          ? body.metaDescription
          : existingTranslation.metaDescription,
      translationSource:
        body.translationSource || existingTranslation.translationSource,
      humanReviewed:
        body.humanReviewed !== undefined
          ? body.humanReviewed
          : existingTranslation.humanReviewed,
    };

    console.log('✏️ Updating translation for post:', postId, 'language:', languageCode);

    const updatedTranslation = await PostTranslationsService.upsertPostTranslation(
      postId,
      translationData
    );
    ...
    console.error(
      '❌ Error in PUT /api/admin/posts/[id]/translations/[translationId]:',
      error
    );
    return NextResponse.json(
      {
...
export async function DELETE(
  ...
  try {
    ...
    console.error(
      '❌ Error in DELETE /api/admin/posts/[id]/translations/[translationId]:',
      error
    );
    return NextResponse.json(
      {
