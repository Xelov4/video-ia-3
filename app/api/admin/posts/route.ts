...
export async function GET(request: NextRequest) {
  try {
    ...
    const params = {
      ...
      limit: parseInt(searchParams.get('limit') || searchParams.get('pageSize') || '20'),
      sortBy: searchParams.get('sortBy') || searchParams.get('sortOrder') || 'updatedAt',
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('📝 Creating post:', { slug: postData.slug, authorId: postData.authorId })
