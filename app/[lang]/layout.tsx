 ...
 */
const METADATA_BY_LANGUAGE: Record<
  SupportedLocale,
  {
    title: string;
    description: string;
...
> = {
  en: {
    ...
    description:
      "Discover the world's largest AI tools directory with 16,765+ verified tools for video creation, content generation, automation and more. Reviews, comparisons and expert insights.",
    keywords:
      'AI tools directory, artificial intelligence, video AI tools, content creation, automation, machine learning',
  },
  fr: {
    title: "Video-IA.net - Meilleur Répertoire d'Outils IA 2025 | 16 765+ Outils IA",
    description:
      "Découvrez le plus grand répertoire d'outils IA au monde avec 16 765+ outils vérifiés pour création vidéo, génération de contenu, automatisation et plus.",
    keywords:
  ...
  it: {
    ...
    description:
      'Scopri la più grande directory di strumenti AI al mondo con 16.765+ strumenti verificati per creazione video, generazione contenuti, automazione e altro.',
    keywords:
      'directory strumenti AI, intelligenza artificiale, strumenti AI video, creazione contenuti',
  },
  es: {
    title:
      'Video-IA.net - Mejor Directorio Herramientas IA 2025 | 16.765+ Herramientas IA',
    description:
      'Descubre el directorio de herramientas IA más grande del mundo con 16.765+ herramientas verificadas para creación de video, generación de contenido y automatización.',
    keywords:
      'directorio herramientas IA, inteligencia artificial, herramientas IA video, creación contenido',
  },
  de: {
    title: 'Video-IA.net - Bestes KI-Tools Verzeichnis 2025 | 16.765+ KI-Tools',
    description:
      'Entdecken Sie das weltgrößte KI-Tools-Verzeichnis mit 16.765+ verifizierten Tools für Videoerstellung, Content-Generierung und Automatisierung.',
    keywords:
      'KI-Tools Verzeichnis, künstliche Intelligenz, Video-KI-Tools, Content-Erstellung',
  },
  nl: {
    title: 'Video-IA.net - Beste AI Tools Directory 2025 | 16.765+ AI Tools',
    description:
      "Ontdek 's werelds grootste AI-tools directory met 16.765+ geverifieerde tools voor video creatie, content generatie en automatisering.",
    keywords:
      'AI-tools directory, kunstmatige intelligentie, video AI-tools, content creatie',
  },
  pt: {
    title:
      'Video-IA.net - Melhor Diretório Ferramentas IA 2025 | 16.765+ Ferramentas IA',
    description:
      'Descubra o maior diretório de ferramentas IA do mundo com 16.765+ ferramentas verificadas para criação de vídeo, geração de conteúdo e automação.',
    keywords:
      'diretório ferramentas IA, inteligência artificial, ferramentas IA vídeo, criação conteúdo',
  },
};
