...
export async function generateMetadata({
  ...
  const metadata = {
    en: {
      ...
      description:
        'Explore 140+ AI tools categories including video creation, automation, machine learning, and more. Find the perfect AI tool for your needs.',
    },
    fr: {
      title: "Catégories d'Outils IA - Parcourir par Type | Video-IA.net",
      description:
        "Explorez 140+ catégories d'outils IA incluant création vidéo, automatisation, machine learning et plus. Trouvez l'outil IA parfait pour vos besoins.",
    },
    de: {
      title: 'KI-Tools Kategorien - Nach Typ durchstöbern | Video-IA.net',
      description:
        'Erkunden Sie 140+ KI-Tools-Kategorien einschließlich Videoerstellung, Automatisierung, maschinelles Lernen und mehr. Finden Sie das perfekte KI-Tool für Ihre Bedürfnisse.',
    },
    nl: {
      title: 'AI Tools Categorieën - Bladeren per Type | Video-IA.net',
      description:
        'Verken 140+ AI-tools categorieën inclusief videocreatie, automatisering, machine learning en meer. Vind de perfecte AI-tool voor uw behoeften.',
    },
    it: {
      title: 'Categorie Strumenti IA - Sfoglia per Tipo | Video-IA.net',
      description:
        'Esplora 140+ categorie di strumenti IA incluse creazione video, automazione, machine learning e altro. Trova lo strumento IA perfetto per le tue esigenze.',
    },
    es: {
      title: 'Categorías de Herramientas IA - Navegar por Tipo | Video-IA.net',
      description:
        'Explora 140+ categorías de herramientas IA incluyendo creación de video, automatización, machine learning y más. Encuentra la herramienta IA perfecta para tus necesidades.',
    },
    pt: {
      title: 'Categorias de Ferramentas IA - Navegar por Tipo | Video-IA.net',
      description:
        'Explore 140+ categorias de ferramentas IA incluindo criação de vídeo, automação, machine learning e mais. Encontre a ferramenta IA perfeita para suas necessidades.',
    },
  };
...
export default async function CategoriesPage({
  ...
  const { lang, sortBy, sortOrder, viewMode } = await validateAndParseParams(
    params,
    searchParams
  );
    ...
    return (
      <div className='flex min-h-screen items-center justify-center bg-background'>
        <div className='text-center'>
          <h1 className='mb-4 text-2xl font-bold'>Error Loading Categories</h1>
