...
export default async function UseCasesPage({ params }: UseCasesPageProps) {
  ...
  const serializedUseCases = Array.from(useCases.values())
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {serializedUseCases.map((useCase) => (
            <div key={useCase.slug} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="p-6">
