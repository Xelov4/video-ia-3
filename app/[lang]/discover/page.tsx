...
export async function generateMetadata({
  ...
  const seoContent = {
    en: {
      ...
      keywords:
        'discover AI tools, AI tools finder, advanced search, AI tools by category, AI tools for developers, AI tools for creators',
    },
    fr: {
      ...
      keywords:
        'découvrir outils IA, chercheur outils IA, recherche avancée, outils IA par catégorie, outils IA développeurs, outils IA créateurs',
    },
    it: {
      ...
      keywords:
        'scoprire strumenti AI, finder strumenti AI, ricerca avanzata, strumenti AI per categoria',
    },
    es: {
      ...
      keywords:
        'descubrir herramientas IA, buscador herramientas IA, búsqueda avanzada, herramientas IA por categoría',
    },
    de: {
      ...
      keywords:
        'KI-Tools entdecken, KI-Tools Finder, erweiterte Suche, KI-Tools nach Kategorie',
    },
    nl: {
      ...
      keywords:
        'AI-tools ontdekken, AI-tools finder, geavanceerd zoeken, AI-tools per categorie',
    },
    pt: {
      ...
      keywords:
        'descobrir ferramentas IA, localizador ferramentas IA, busca avançada, ferramentas IA por categoria',
    },
  };
  ...
  const currentUrl =
    validatedLang === 'en'
      ? `${baseUrl}/discover`
      : `${baseUrl}/${validatedLang}/discover`;
