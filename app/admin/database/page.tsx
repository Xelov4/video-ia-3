  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Gestion de la base de données</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">15 tables actives</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">23% CPU • 67% RAM</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">SSL actif</p>
          </CardContent>
        </Card>
      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  Les opérations de maintenance peuvent affecter les performances. 
                  Il est recommandé de les effectuer durant les heures de faible trafic.
                </AlertDescription>
              </Alert>
