      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Analysez automatiquement les outils d'intelligence artificielle avec des logs en temps réel
          </p>
        </div>
        ...
        {activeTab === 'form' && (
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h2 className="text-2xl font-bold mb-6 text-gray-900">Analyse d'outil IA par URL</h2>
            ...
            <form onSubmit={handleScrape} className="space-y-6">
              ...
              <div className="flex items-center space-x-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-blue-900 mb-2">🚀 Mode Professionnel</h3>
        ...
        {activeTab === 'database' && (
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h2 className="text-2xl font-bold mb-6 text-gray-900">Analyse d'outils depuis la base de données</h2>
            ...
            {/* Tools List */}
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Outils disponibles ({tools.length})</h3>
            ...
            {selectedTool && (
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Champs à mettre à jour</h3>
        ...
        {activeTab === 'batch' && (
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h2 className="text-2xl font-bold mb-6 text-gray-900">⚡ Traitement en lot des outils</h2>
            ...
            {batchProcessing && (
              <div className="mb-6 bg-gray-50 rounded-lg p-4">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-gray-700">Progression du traitement</span>
                  <span className="text-sm text-gray-900 font-medium">{batchProgress}/{batchTotal}</span>
                </div>
            ...
            <div className="mb-4 flex items-center justify-between bg-gray-50 rounded-lg p-4">
              <div>
                ...
                <span className="text-gray-600 text-sm ml-2">sur {tools.length} disponible{tools.length !== 1 ? 's' : ''}</span>
              </div>
            ...
            {/* Field Selection */}
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Champs à optimiser</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {UPDATE_FIELDS.map((field) => (
                  <label key={field.key} className="flex items-center space-x-3 cursor-pointer">
                    <input
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Lancement du traitement en lot</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    <div>
                      <span className="text-sm font-medium text-gray-600">Nom de l'outil:</span>
                      <p className="text-gray-900 font-medium">{result.toolName}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      <span className="text-sm font-medium text-gray-600">Modèle de prix:</span>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {result.tags.map((tag, index) => (
                      <span key={index} className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gray-200 text-gray-800">
                        {tag}
                      </span>
                    ))}
                  </div>
              ...
              <div className="space-y-6">
                ...
                {result.pricingDetails && (
                  <div className="bg-gray-50 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">💰 Détails de prix</h3>
                    <div className="space-y-3">
                      <div>
                        <span className="text-sm font-medium text-gray-600">Modèle:</span>
                        <span className="ml-2 text-gray-900">{result.pricingDetails.model}</span>
                      </div>
                      <div>
                        <span className="text-sm font-medium text-gray-600">Niveau gratuit:</span>
                        <span className={`ml-2 ${result.pricingDetails.freeTier ? 'text-green-600' : 'text-red-600'}`}>
                          {result.pricingDetails.freeTier ? '✅ Oui' : '❌ Non'}
                        </span>
                      </div>
                      <div>
                        <span className="text-sm font-medium text-gray-600">Plans payants:</span>
                        <span className={`ml-2 ${result.pricingDetails.paidPlans ? 'text-green-600' : 'text-red-600'}`}>
                      ...
                      {result.pricingDetails.pricingNotes && (
                        <div>
                          ...
                          <p className="text-gray-700 mt-1">{result.pricingDetails.pricingNotes}</p>
                        </div>
                      )}
                    </div>
                  </div>
                ...
                {result.affiliateInfo && (
                  <div className="bg-gray-50 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">🤝 Programme d'affiliation</h3>
                    <div className="space-y-3">
                      <div>
                        <span className="text-sm font-medium text-gray-600">Programme disponible:</span>
                        <span className={`ml-2 ${result.affiliateInfo.hasAffiliateProgram ? 'text-green-600' : 'text-red-600'}`}>
                      ...
                      {result.affiliateInfo.notes && (
                        <div>
                          <span className="text-sm font-medium text-gray-600">Notes:</span>
                          <p className="text-gray-700 mt-1">{result.affiliateInfo.notes}</p>
                        </div>
                      )}
                    </div>
                  </div>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm text-gray-600">Complétude des données</span>
                      <span className="text-sm font-medium text-gray-900">{result.dataCompleteness}%</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
