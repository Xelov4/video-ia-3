...
const categoriesData = [
  { 
    ...
    translations: {
      fr: { name: 'Génération de Vidéo', description: 'Outils pour créer et éditer des vidéos avec l\'IA.' },
      en: { name: 'Video Generation', description: 'Tools for creating and editing videos with AI.' }
    }
  },
  { 
    name: 'AI Chatbot', 
    slug: 'ai-chatbot',
    translations: {
      fr: { name: 'Chatbot IA', description: 'Assistants conversationnels intelligents.' },
  ...
  { 
    ...
    translations: {
      fr: { name: 'Génération d\'Image', description: 'Créez des images uniques à partir de texte.' },
  ...
  },
  {
    ...
    translations: {
      fr: { name: 'Synthèse Vocale', description: 'Générez des voix humaines réalistes.' },
...
async function main() {
  ...
  await prisma.tool.create({
    data: {
      ...
      overview: 'An AI-powered video creation platform to generate stunning videos from text prompts.',
      toolDescription: 'Full description of AI Video Wizard, detailing its features like multiple languages, styles, and high-resolution output.',
      isActive: true,
      featured: true,
      quality_score: 4.8,
      translations: {
        create: [
          {
            ...
            overview: 'Une plateforme de création vidéo IA pour générer des vidéos époustouflantes à partir de textes.',
            description: 'Description complète de Magicien Vidéo IA, détaillant ses fonctionnalités comme le support multilingue, les styles variés et la sortie haute résolution.',
          }
        ]
      },
      toolCategories: {
  ...
  await prisma.tool.create({
    data: {
      ...
      overview: 'Generate high-quality, royalty-free images in seconds with our advanced AI model.',
      toolDescription: 'Pixel Perfect is a state-of-the-art image generator. You can use it for social media, marketing materials, or personal projects.',
      isActive: true,
      featured: false,
      quality_score: 4.5,
      translations: {
        create: [
          {
            languageCode: 'fr',
            name: 'Pixel Parfait',
            overview: 'Générez des images de haute qualité, libres de droits, en quelques secondes avec notre modèle IA avancé.',
            description: 'Pixel Parfait est un générateur d\'images de pointe. Vous pouvez l\'utiliser pour les réseaux sociaux, le marketing ou vos projets personnels.',
          }
        ]
      },
      toolCategories: {
  ...
  await prisma.tool.create({
    data: {
      ...
      toolDescription: 'VoiceGen provides an API to convert text into natural-sounding speech in over 30 languages and accents.',
      isActive: false,
      featured: true,
      quality_score: 4.9,
      translations: {
        create: [
          {
            ...
            description: 'VoiceGen fournit une API pour convertir du texte en parole naturelle dans plus de 30 langues et accents.',
          }
        ]
      },
      toolCategories: {
