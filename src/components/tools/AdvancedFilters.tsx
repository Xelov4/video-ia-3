      ...
      <div className='space-y-6'>
        ...
        <div>
          ...
          <div className='mb-4'>
            ...
            <select
              ...
              className='w-full rounded-md border border-gray-300 px-3 py-2 focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white'
            >
              <option value=''>
                {lang === 'fr' ? 'Toutes les audiences' : 'All audiences'}
              </option>
          ...
          <div className='mb-4'>
            ...
            >
              <option value=''>
                {lang === 'fr' ? "Tous les cas d'usage" : 'All use cases'}
              </option>
          ...
          <div className='mb-4'>
            ...
            <div className='flex items-center gap-2'>
              <input
                ...
                className='flex-1'
              />
              <span className='min-w-[60px] text-sm text-gray-600 dark:text-gray-400'>
                {filters.minQuality}+
              </span>
            </div>
          </div>
        ...
        <div className='border-t pt-6'>
          ...
          <div className='mb-4'>
            ...
            >
              ...
              <option value='freemium'>
                {lang === 'fr' ? 'Freemium' : 'Freemium'}
              </option>
              <option value='paid'>{lang === 'fr' ? 'Payant' : 'Paid'}</option>
              <option value='enterprise'>
                {lang === 'fr' ? 'Entreprise' : 'Enterprise'}
              </option>
            </select>
          </div>
          ...
          <div className='mb-4'>
            ...
            >
              <option value=''>
                {lang === 'fr' ? 'Toutes les plateformes' : 'All platforms'}
              </option>
            ...
            <div className='space-y-2'>
              <div className='flex items-center gap-2'>
                <input
                  ...
                  onChange={e =>
                    onFilterChange('minViews', parseInt(e.target.value) || 0)
                  }
                ...
                <input
                  ...
                  onChange={e =>
                    onFilterChange('maxViews', parseInt(e.target.value) || 999999)
                  }
                  className='flex-1 rounded border border-gray-300 px-2 py-1 text-sm'
                />
              </div>
          ...
          <div className='mb-4'>
            ...
            >
              ...
              <option value='quarter'>
                {lang === 'fr' ? 'Ce trimestre' : 'This quarter'}
              </option>
              <option value='year'>
                {lang === 'fr' ? 'Cette année' : 'This year'}
              </option>
            </select>
          </div>
