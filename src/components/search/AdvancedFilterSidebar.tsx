...
import { Search, Filter, X, Star, Zap, Users, Target, Tag, SlidersHorizontal, Sparkles, Bot, TrendingUp } from 'lucide-react'
...
export default function AdvancedFilterSidebar({
  ...
  return (
    <div className="w-80 bg-background border-r h-screen overflow-y-auto">
      ...
      <div className="p-4 space-y-6">
        ...
        <Tabs defaultValue="categories" className="w-full">
          <TabsList className="grid w-full grid-cols-4">
            <TabsTrigger value="categories" className="text-xs">Cat.</TabsTrigger>
            <TabsTrigger value="audiences" className="text-xs">Public</TabsTrigger>
            <TabsTrigger value="pricing" className="text-xs">Prix</TabsTrigger>
            <TabsTrigger value="features" className="text-xs">Options</TabsTrigger>
          </TabsList>
                ...
                return (
                  <div
                    ...
                    onClick={() => updateFilters({
                      categories: toggleArrayFilter(filters.categories, category.name)
                    })}
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-muted-foreground">{category.count} outils</div>
                    </div>
                  </div>
                )
              })}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-muted-foreground">{audience.count} outils</div>
                    </div>
                  </div>
                )
              })}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-muted-foreground">{option.count} outils</div>
                    </div>
                  </div>
                )
              })}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-muted-foreground">{feature.count} outils</div>
                    </div>
                  </div>
                )
              })}
            ...
            <CardContent className="pt-4">
              ...
              <div className="space-y-2">
                ...
                {filters.audiences.map(aud => (
                  <Badge key={aud} variant="secondary" className="mr-1 mb-1">
                    {aud}
                    <X 
                      className="h-3 w-3 ml-1 cursor-pointer"
                      onClick={() => updateFilters({
