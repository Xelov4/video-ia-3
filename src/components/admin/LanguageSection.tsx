      ...
      <div className={`bg-white rounded-lg shadow p-6 ${className}`}>
        ...
        <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
          <div className="flex items-center">
            <GlobeAltIcon className="w-12 h-12 text-indigo-400 mr-4" />
            <div>
              <h3 className="text-sm font-medium text-indigo-800">
                Contenu principal géré ci-dessus
              </h3>
              <p className="text-xs text-indigo-600">
                Les champs de la langue de base sont modifiés dans les sections principales de cette page.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex justify-center space-x-3">
            {onCopyFromBase && (
              <button
                ...
                className="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium text-gray-700 bg-white rounded-lg hover:bg-gray-50"
                type="button"
              >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div className="flex items-center space-x-2">
          {onCopyFromBase && (
            <button
              onClick={handleCopyFromBase}
              className="inline-flex items-center px-3 py-2 border border-gray-300 text-sm font-medium text-gray-700 bg-white rounded-lg hover:bg-gray-50"
              type="button"
            >
          ...
          {onAutoTranslate && (
            <button
              onClick={handleAutoTranslate}
              disabled={autoTranslating}
              className="inline-flex items-center px-3 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 disabled:opacity-50"
              type="button"
            >
