...
export default function Footer({
  ...
  const translations = {
    en: {
      ...
      description:
        'The most comprehensive directory of artificial intelligence tools for creators, developers and professionals. Discover the best AI tools on the market.',
      home: 'Home',
      allTools: 'All Tools',
    ...
    fr: {
      ...
      description:
        "Le répertoire le plus complet d'outils d'intelligence artificielle pour les créateurs, développeurs et professionnels. Découvrez les meilleurs outils IA du marché.",
      home: 'Accueil',
    ...
    es: {
      ...
      description:
        'El directorio más completo de herramientas de inteligencia artificial para creadores, desarrolladores y profesionales. Descubre las mejores herramientas IA del mercado.',
      home: 'Inicio',
    ...
    it: {
      ...
      description:
        'La directory più completa di strumenti di intelligenza artificiale per creatori, sviluppatori e professionisti. Scopri i migliori strumenti IA del mercato.',
      home: 'Home',
    ...
    de: {
      ...
      description:
        'Das umfassendste Verzeichnis von KI-Tools für Kreative, Entwickler und Fachleute. Entdecken Sie die besten KI-Tools auf dem Markt.',
      home: 'Startseite',
      allTools: 'Alle Tools',
    ...
    nl: {
      tagline: 'AI Tools Directory',
      description:
        'De meest uitgebreide directory van AI-tools voor makers, ontwikkelaars en professionals. Ontdek de beste AI-tools op de markt.',
      home: 'Home',
      allTools: 'Alle tools',
    ...
    pt: {
      ...
      description:
        'O diretório mais completo de ferramentas de inteligência artificial para criadores, desenvolvedores e profissionais. Descubra as melhores ferramentas IA do mercado.',
      home: 'Início',
  ...
  const popularCategories = [
    {
      href: `/${currentLanguage === 'en' ? '' : currentLanguage}/c/writing-assistant`,
      label: t.writingAssistant,
    },
    {
      href: `/${currentLanguage === 'en' ? '' : currentLanguage}/c/image-editing`,
      label: t.imageEditing,
    },
    {
      href: `/${currentLanguage === 'en' ? '' : currentLanguage}/c/video-editing`,
      label: t.videoEditing,
    },
    {
      href: `/${currentLanguage === 'en' ? '' : currentLanguage}/c/music`,
      label: t.music,
    },
    {
      href: `/${currentLanguage === 'en' ? '' : currentLanguage}/c/productivity`,
      label: t.productivity,
    },
    {
      href: `/${currentLanguage === 'en' ? '' : currentLanguage}/c/chatbot`,
      label: t.chatbots,
    },
  ];
        ...
        <div className='grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4'>
          ...
          <div className='lg:col-span-1'>
            <div className='mb-6 flex items-center space-x-4'>
              ...
              <div>
                <h3 className='gradient-text text-2xl font-bold'>Video-IA.net</h3>
                <p className='text-sm font-medium text-gray-400'>{t.tagline}</p>
              </div>
            </div>
            ...
            <div className='mb-8 grid grid-cols-2 gap-4'>
              <div className='glass-effect rounded-2xl border border-gray-700/50 p-4 text-center'>
                <div className='gradient-text text-3xl font-bold'>
                  {formatNumber(totalToolsCount)}
                </div>
                <div className='text-sm font-medium text-gray-400'>AI Tools</div>
              </div>
              <div className='glass-effect rounded-2xl border border-gray-700/50 p-4 text-center'>
                <div className='gradient-text text-3xl font-bold'>
                  {totalCategoriesCount}
                </div>
                <div className='text-sm font-medium text-gray-400'>{t.categories}</div>
              </div>
            </div>
            ...
            <div className='flex space-x-4'>
              {socialLinks.map(social => (
                <a
                  ...
                  className='glass-effect group rounded-xl p-3 transition-all duration-200 hover:bg-gray-700/50'
                  aria-label={social.label}
                >
                  <div className='text-gray-400 transition-colors duration-200 group-hover:text-purple-400'>
                    {social.icon}
                  </div>
                </a>
              ))}
          ...
          {/* Navigation */}
          <div>
            <h4 className='mb-6 text-xl font-semibold text-white'>{t.home}</h4>
            <ul className='space-y-3'>
              {quickLinks.map(link => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className='hover:gradient-text text-base font-medium text-gray-300 transition-all duration-200 hover:text-white'
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          {/* Resources */}
          <div>
            <h4 className='mb-6 text-xl font-semibold text-white'>{t.resources}</h4>
            <ul className='space-y-3'>
              {resourceLinks.map(resource => (
                <li key={resource.href}>
                  <Link
                    href={resource.href}
                    className={`hover:gradient-text flex items-center space-x-2 text-base font-medium text-gray-300 transition-all duration-200 hover:text-white ${
      ...
      <div className='border-t border-gray-700/50'>
        <div className='mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8'>
          <div className='flex flex-col items-center justify-between md:flex-row'>
            <div className='mb-4 text-base font-medium text-gray-400 md:mb-0'>
