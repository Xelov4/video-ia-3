  ...
  return (
    <header className={`sticky top-0 z-50 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            ...
            <div className="relative">
              ...
              {isCategoriesOpen && (
                <div className="absolute right-0 mt-3 w-96 glass-effect rounded-2xl shadow-2xl border border-gray-700/50 py-4 z-50">
                  ...
                  <div className="border-t border-gray-700/50 pt-3 px-6">
                    <Link
                      href="/categories"
                      onClick={() => setIsCategoriesOpen(false)}
          ...
          <div className="flex items-center space-x-4">
            <form onSubmit={handleSearch} className="hidden lg:block">
              <div className="relative">
                <div className={`transition-all duration-300 ${
                  ...
                  />
                  <MagnifyingGlassIcon className={`absolute left-4 top-4 h-5 w-5 transition-colors duration-200 ${
            ...
            <button
              ...
              className="md:hidden relative p-3 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 text-gray-300 hover:text-white hover:bg-white/20 transition-all duration-300 hover:scale-105"
            >
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-black/95 backdrop-blur-2xl border-t border-white/10 shadow-2xl">
