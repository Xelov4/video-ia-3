...
var ToolContentUpdaterService = /** @class */ (function () {
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              axios_1.default.get(tool.toolLink, {
                timeout: this.REQUEST_TIMEOUT,
                maxRedirects: 5,
                validateStatus: function (status) {
                  return status < 600;
                }, // Accepter tous les codes < 600
              }),
            ];
          case 1:
            response = _e.sent();
            ...
            console.log(
              '\uD83D\uDCCA Mise \u00E0 jour DB: HTTP '
                .concat(httpStatusCode, ', isActive: ')
                .concat(isActive)
            );
            return [
              4 /*yield*/,
              client_1.prisma.tool.update({
                where: { id: tool.id },
                data: {
          ...
          case 2:
            updatedTool = _e.sent();
            console.log(
              '\u2705 DB mise \u00E0 jour confirm\u00E9e via Prisma - Tool ID: '
                .concat(updatedTool.id, ', HTTP: ')
                .concat(updatedTool.httpStatusCode, ', Active: ')
                .concat(updatedTool.isActive)
            );
            return [
              2 /*return*/,
              {
                ...
                isActive: isActive,
                redirectUrl:
                  ((_b = response.request.res) === null || _b === void 0
                    ? void 0
                    : _b.responseUrl) !== tool.toolLink
                    ? (_c = response.request.res) === null || _c === void 0
                      ? void 0
                      : _c.responseUrl
                    : undefined,
              },
          ...
          case 3:
            error_1 = _e.sent();
            httpStatusCode =
              ((_d = error_1.response) === null || _d === void 0
                ? void 0
                : _d.status) || 0;
            console.log(
              '\u274C Erreur HTTP: '
                .concat(error_1.message, ', Code: ')
                .concat(httpStatusCode)
            );
            console.log(
              '\uD83D\uDCCA Mise \u00E0 jour DB: HTTP '.concat(
                httpStatusCode,
                ', isActive: false (\u00E9chec)'
              )
            );
            return [
              4 /*yield*/,
          ...
          case 4:
            ...
            console.log(
              '\u2705 DB mise \u00E0 jour confirm\u00E9e via Prisma - Tool ID: '
                .concat(updatedTool.id, ', HTTP: ')
                .concat(updatedTool.httpStatusCode, ', Active: ')
                .concat(updatedTool.isActive, ' (outil marqu\u00E9 inactif)')
            );
            return [
              2 /*return*/,
              {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            console.log(
              "\uD83D\uDCF8 Capture d'\u00E9cran de ".concat(tool.toolLink, '...')
            );
          ...
          case 12:
            ...
            _b.sent();
            console.log(
              '\u2705 Screenshot sauvegard\u00E9: '.concat(relativeScreenshotPath)
            );
            return [2 /*return*/, relativeScreenshotPath];
          case 13:
            error_3 = _b.sent();
            console.error(
              "\u274C Erreur capture d'\u00E9cran: ".concat(error_3.message)
            );
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            sanitizedName = tool.toolName.replace(/[^a-zA-Z0-9]/g, '_').toLowerCase();
            tempDirPath = path.join(
              process.cwd(),
              ''.concat(this.TEMP_DIR_PREFIX).concat(sanitizedName)
            );
            _b.label = 1;
          case 1:
            _b.trys.push([1, 3, , 4]);
          ...
          case 4:
              ...
              return __generator(this, function (_c) {
                switch (_c.label) {
                  case 0:
                    ...
                    if (visitedUrls.has(currentUrl)) {
                      console.log(
                        '\u23ED\uFE0F  Page '.concat(
                          i + 1,
                          ': URL d\u00E9j\u00E0 visit\u00E9e, passage \u00E0 la suivante'
                        )
                      );
                    ...
                    console.log(
                      '\uD83D\uDD0D Page '
                        .concat(i + 1, '/')
                        .concat(this_1.MAX_PAGES_TO_CRAWL, ': Crawl de ')
                        .concat(currentUrl)
                    );
                    _c.label = 1;
                  case 1:
                    ...
                    return [
                      4 /*yield*/,
                      new Promise(function (resolve) {
                        return setTimeout(resolve, _this.CRAWL_DELAY);
                      }),
                    ];
                  case 2:
                    _c.sent();
                    return [
                      4 /*yield*/,
                      axios_1.default.get(currentUrl, {
                  ...
                  case 3:
                    ...
                    title =
                      $_1('title').text() || $_1('h1').first().text() || 'No Title';
                    crawledContent = {
                      url: currentUrl,
                      content: content,
                      title: title,
                    ...
                    filename = 'page_'
                      .concat(i + 1, '_')
                      .concat(currentUrl.replace(/[^a-zA-Z0-9]/g, '_'), '.json');
                    return [
                      4 /*yield*/,
                      fs.writeFile(
                  ...
                  case 4:
                    ...
                    console.log(
                      '\u2705 Page '
                        .concat(i + 1, ' crawl\u00E9e: "')
                        .concat(title, '" (')
                        .concat(content.length, ' caract\u00E8res)')
                    );
                    ...
                    if (crawledPages.length < this_1.MAX_PAGES_TO_CRAWL) {
                      ...
                      console.log(
                        '\uD83D\uDD17 '.concat(
                          newLinks,
                          ' nouveaux liens trouv\u00E9s sur cette page'
                        )
                      );
                    }
                    return [3 /*break*/, 6];
                  case 5:
                    ...
                    errorCount++;
                    console.error(
                      '\u274C Erreur lors du crawl de '
                        .concat(currentUrl, ': ')
                        .concat(error_5.message)
                    );
                    return [3 /*break*/, 6];
                  case 6:
                    return [2 /*return*/];
            ...
            _b.label = 5;
          case 5:
            if (!(i < this.MAX_PAGES_TO_CRAWL && urlsToVisit.length > 0))
              return [3 /*break*/, 8];
          ...
          case 8:
            ...
            if (crawledPages.length < this.MAX_PAGES_TO_CRAWL) {
              if (urlsToVisit.length === 0) {
                crawlStopReason = 'Plus de liens internes \u00E0 crawler ('.concat(
                  newLinksFound,
                  ' liens d\u00E9couverts au total)'
                );
              } else if (errorCount > crawledPages.length / 2) {
                crawlStopReason = "Trop d'erreurs de crawl (".concat(
                  errorCount,
                  ' erreurs)'
                );
              } else {
                crawlStopReason = 'Structure du site limit\u00E9e ('.concat(
                  crawledPages.length,
                  ' pages accessibles)'
                );
              }
              console.log(
                '\u26A0\uFE0F  Crawling arr\u00EAt\u00E9 \u00E0 '
                  .concat(crawledPages.length, '/')
                  .concat(this.MAX_PAGES_TO_CRAWL, ' pages')
              );
              console.log('\uD83D\uDCDD Raison: '.concat(crawlStopReason));
              console.log(
                '\uD83D\uDCCA Statistiques: '
                  .concat(newLinksFound, ' liens d\u00E9couverts, ')
                  .concat(errorCount, ' erreurs, ')
                  .concat(visitedUrls.size, ' URLs visit\u00E9es')
              );
            } else {
              console.log(
                '\uD83C\uDFAF Crawling complet: '
                  .concat(this.MAX_PAGES_TO_CRAWL, '/')
                  .concat(this.MAX_PAGES_TO_CRAWL, ' pages crawl\u00E9es')
              );
            }
            return [
              2 /*return*/,
        ...
        switch (_b.label) {
          case 0:
            ...
            linksText = Object.entries(links)
              ...
              .join('\n');
            prompt_1 =
              'You are a link validation expert. I need you to validate if the following '
                .concat(linkType, ' links are actually related to the tool "')
                .concat(tool.toolName, '" (URL: ')
                .concat(tool.toolLink, ').\n\nTool to validate: ')
                .concat(tool.toolName, '\nTool URL: ')
                .concat(tool.toolLink, '\nTool Category: ')
                .concat(tool.toolCategory || 'Unknown', '\n\n')
                .concat(
                  linkType === 'social' ? 'Social media' : 'Useful',
                  ' links found:\n'
                )
                .concat(
                  linksText,
                  '\n\nIMPORTANT: \n- Remove any generic links (like "github.com/github", "fonts.googleapis.com", "docs.github.com" for general GitHub docs)\n- Keep only links that are SPECIFICALLY related to "'
                )
                .concat(
                  tool.toolName,
          ...
          case 1:
            ...
            try {
              ...
              if (jsonMatch) {
                ...
                console.log(
                  '\uD83E\uDD16 Gemini validation: '
                    .concat(Object.keys(links).length, ' -> ')
                    .concat(Object.keys(validatedLinks).length, ' links')
                );
                return [2 /*return*/, validatedLinks];
              }
            } catch (parseError) {
              console.log(
                '⚠️ Erreur parsing validation Gemini, conservation des liens originaux'
              );
            }
            return [2 /*return*/, links];
          case 2:
            error_6 = _b.sent();
            console.log(
              '\u26A0\uFE0F Erreur validation Gemini ('
                .concat(linkType, '): ')
                .concat(error_6.message)
            );
            return [2 /*return*/, links];
          case 3:
            return [2 /*return*/];
      ...
      return __generator(this, function (_g) {
        switch (_g.label) {
          case 0:
            ...
            for (
              _i = 0, crawledPages_1 = crawledPages;
              _i < crawledPages_1.length;
              _i++
            ) {
                  ...
                  for (_e = 0, patterns_1 = patterns; _e < patterns_1.length; _e++) {
                    ...
                    if (matches) {
                      ...
                      for (_f = 0, matches_1 = matches; _f < matches_1.length; _f++) {
                        match = matches_1[_f];
                        if (
                          this.validateSocialLink(match, validationKeywords, platform)
                        ) {
            ...
            return [
              4 /*yield*/,
              this.validateLinksWithGemini(socialLinks, tool, 'social'),
            ];
          case 1:
   ...
   */
  ToolContentUpdaterService.validateSocialLink = function (
    link,
    validationKeywords,
    platform
  ) {
    ...
    if (
      genericPatterns.some(function (generic) {
        return linkLower.includes(generic);
      })
    ) {
      return false;
    }
    ...
    for (
      var _i = 0, validationKeywords_1 = validationKeywords;
      _i < validationKeywords_1.length;
      _i++
    ) {
      ...
      return __generator(this, function (_k) {
        switch (_k.label) {
          case 0:
            ...
            for (
              _i = 0, crawledPages_2 = crawledPages;
              _i < crawledPages_2.length;
              _i++
            ) {
              ...
              if (!usefulLinks.docsLink) {
                for (_d = 0, _e = patterns.docsLink; _d < _e.length; _d++) {
                  ...
                  matches = combinedContent.match(pattern);
                  if (matches && matches.length > 0) {
                    usefulLinks.docsLink = matches[0]
                      .replace(/href=["']/, '')
                      .replace(/["'].*/, '');
                    break;
                  }
              ...
              if (!usefulLinks.affiliateLink) {
                for (_f = 0, _g = patterns.affiliateLink; _f < _g.length; _f++) {
                  ...
                  matches = combinedContent.match(pattern);
                  if (matches && matches.length > 0) {
                    usefulLinks.affiliateLink = matches[0]
                      .replace(/href=["']/, '')
                      .replace(/["'].*/, '');
                    break;
                  }
              ...
              if (!usefulLinks.changelogLink) {
                for (_h = 0, _j = patterns.changelogLink; _h < _j.length; _h++) {
                  ...
                  matches = combinedContent.match(pattern);
                  if (matches && matches.length > 0) {
                    usefulLinks.changelogLink = matches[0]
                      .replace(/href=["']/, '')
                      .replace(/["'].*/, '');
                    break;
                  }
            ...
            console.log(
              '\uD83E\uDD16 Validation Gemini des '.concat(
                Object.keys(usefulLinks).length,
                ' liens utiles...'
              )
            );
            return [
              4 /*yield*/,
              this.validateLinksWithGemini(usefulLinks, tool, 'useful'),
            ];
          case 1:
        ...
        switch (_b.label) {
          case 0:
            ...
            crawledContent = crawledPages
              ...
              .join('\n');
            prompt_2 =
              'You are a passionate journalist specializing in AI Tools and technologies. You are 28 years old and you love speaking directly to your audience while respecting them and paying great attention to the quality and clarity of the information you provide. You constantly try to give additional details and examples to dig deeper into topics.\n\nHere is a collection of several web pages about the tool '
                .concat(
                  tool.toolName,
                  ". I want you to write an article that explains what this tool is, what it's used for, and why someone would want to use it. I also want you to give reasons why this tool might not be the most interesting option, if you find any. You don't need to follow this brief to the letter.\n\nI want you to write a minimum of 300 words divided into at least 3 parts and up to 6 parts. Use H2 titles and always use \"What's "
                )
                .concat(
                  tool.toolName,
                  '?" for the first title. For the other titles, you can choose.\n\nIMPORTANT: Write the entire article in ENGLISH.\n\nTool to analyze: '
                )
                .concat(tool.toolName, '\nCategory: ')
                .concat(tool.toolCategory || 'Undefined', '\nURL: ')
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 3:
            ...
            console.log(
              '\u2705 Contenu g\u00E9n\u00E9r\u00E9 avec succ\u00E8s par '
                .concat(modelName, ' (')
                .concat(text.length, ' caract\u00E8res)')
            );
          ...
          case 4:
            ...
            lastError = error_8;
            console.log(
              '\u274C \u00C9chec avec '.concat(modelName, ': ').concat(error_8.message)
            );
            if (
              !(
                error_8.message.includes('overloaded') ||
                error_8.message.includes('rate limit')
              )
            )
              return [3 /*break*/, 6];
            return [
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            crawledSummary = crawledPages
              .slice(0, 3)
              .map(function (page) {
                return ''
                  .concat(page.title, ': ')
                  .concat(page.content.substring(0, 500), '...');
              })
              .join('\n\n');
            prompt_3 =
              'You are an expert at writing concise tool descriptions. Based on the crawled content below, write a very brief overview of '
                .concat(tool.toolName, '.\n\nTool: ')
                .concat(tool.toolName, '\nCategory: ')
                .concat(tool.toolCategory || 'AI Tool', '\nURL: ')
            ...
            return [
              4 /*yield*/,
              this.callGeminiWithFallback(prompt_3),
              // Nettoyer la réponse
            ];
          case 1:
            ...
            sentences = cleanOverview.split(/[.!?]+/).filter(function (s) {
              return s.trim().length > 0;
            });
            if (sentences.length !== 2) {
              if (sentences.length === 1) {
                throw new Error(
                  'Overview doit contenir exactement 2 phrases, 1 trouvée'
                );
              } else {
            ...
            console.log(
              '\u2705 Overview g\u00E9n\u00E9r\u00E9 avec succ\u00E8s ('.concat(
                cleanOverview.length,
                ' caract\u00E8res)'
              )
            );
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            crawledContent = crawledPages
              ...
              .map(function (page) {
                return ''
                  .concat(page.title, ': ')
                  .concat(page.content.substring(0, 1000), '...');
              })
              .join('\n\n');
            prompt_4 =
              'You are an expert at identifying key use cases for tools. Based on the crawled content below, identify the main use cases and problems that '
                .concat(tool.toolName, ' can solve.\n\nTool: ')
                .concat(tool.toolName, '\nCategory: ')
                .concat(tool.toolCategory || 'AI Tool', '\n\nCrawled content:\n')
                .concat(
                  crawledContent,
            ...
            return [
              4 /*yield*/,
              this.callGeminiWithFallback(prompt_4),
          ...
          case 2:
            error_10 = _b.sent();
            console.error(
              '❌ Erreur génération key features Gemini:',
              error_10.message
            );
            return [2 /*return*/, this.generateFallbackKeyFeatures(tool)];
          case 3:
        ...
        switch (_b.label) {
          case 0:
            ...
            crawledSummary = crawledPages
              ...
              .map(function (page) {
                return ''
                  .concat(page.title, ': ')
                  .concat(page.content.substring(0, 800), '...');
              })
              .join('\n\n');
            attempts = 0;
            maxAttempts = 5;
          ...
          case 1:
            ...
            console.log(
              '\uD83D\uDD04 Tentative '
                .concat(attempts, '/')
                .concat(maxAttempts, ' pour meta title avec Video-IA.net')
            );
            prompt_5 =
              'You are an SEO expert. Create SEO-optimized meta title and description for '
                .concat(tool.toolName, '.\n\nTool: ')
                .concat(tool.toolName, '\nCategory: ')
                .concat(tool.toolCategory || 'AI Tool', '\n\nContent summary:\n')
                .concat(
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.callGeminiWithFallback(prompt_5),
          ...
          case 3:
            ...
            if (!titleMatch || !descMatch) {
              console.log(
                '\u274C Tentative '.concat(attempts, ': Format invalide, retry...')
              );
              return [3 /*break*/, 1];
            }
            ...
            if (!metaTitle.endsWith(' - Video-IA.net')) {
              console.log(
                '\u274C Tentative '.concat(
                  attempts,
                  ': Title ne se termine pas par " - Video-IA.net", retry...'
                )
              );
              return [3 /*break*/, 1];
            }
            ...
            if (metaTitle.length > 70) {
              console.log(
                '\u274C Tentative '
                  .concat(attempts, ': Title trop long (')
                  .concat(metaTitle.length, '/70), retry...')
              );
              return [3 /*break*/, 1];
            }
            // SUCCÈS !
            console.log(
              '\u2705 Meta title valid\u00E9 avec Video-IA.net (tentative '.concat(
                attempts,
                ')'
              )
            );
          ...
          case 4:
            error_11 = _b.sent();
            console.log(
              '\u274C Tentative '.concat(attempts, ': Erreur Gemini, retry...')
            );
            if (attempts === maxAttempts) throw error_11;
            return [3 /*break*/, 5];
          case 5:
            return [3 /*break*/, 1];
          case 6:
          ...
          case 0:
            ...
            crawledContent = crawledPages
              ...
              .map(function (page) {
                return ''
                  .concat(page.title, ': ')
                  .concat(page.content.substring(0, 1200), '...');
              })
              .join('\n\n');
            prompt_6 =
              'You are a pricing analysis expert. Based on the crawled content below, determine the pricing model for '
                .concat(tool.toolName, '.\n\nTool: ')
                .concat(tool.toolName, '\nCategory: ')
                .concat(tool.toolCategory || 'AI Tool', '\nURL: ')
                .concat(tool.toolLink, '\n\nContent from crawled pages:\n')
            ...
            return [
              4 /*yield*/,
              this.callGeminiWithFallback(prompt_6),
              // Nettoyer la réponse et valider
            ];
          case 1:
            pricingResponse = _b.sent();
            cleanPricing = pricingResponse
              .replace(/^Pricing Model:?\s*/i, '')
              .trim()
              .toUpperCase();
            validModels = [
              'FREE',
            ...
            if (!validModels.includes(cleanPricing)) {
              ...
              for (
                _i = 0, validModels_1 = validModels;
                _i < validModels_1.length;
                _i++
              ) {
            ...
            console.log(
              '\u2705 Pricing model d\u00E9tect\u00E9: '.concat(cleanPricing)
            );
            return [2 /*return*/, cleanPricing];
          case 2:
            error_13 = _b.sent();
            console.error(
              '❌ Erreur génération pricing model Gemini:',
              error_13.message
            );
            return [2 /*return*/, this.generateFallbackPricingModel(tool)];
          case 3:
        ...
        switch (_b.label) {
          case 0:
            ...
            crawledContent = crawledPages
              ...
              .join('\n\n');
            prompt_7 =
              'You are an expert at identifying practical use cases for tools. Based on the crawled content below, create specific, factual use cases for '
                .concat(tool.toolName, '.\n\nTool: ')
                .concat(tool.toolName, '\nCategory: ')
                .concat(tool.toolCategory || 'AI Tool', '\nURL: ')
                .concat(tool.toolLink, '\n\nContent from crawled pages:\n')
                .concat(
                  crawledContent,
                  '\n\nIMPORTANT: Create exactly 3-4 bullet points that show specific, practical examples of what users can do with '
                )
                .concat(tool.toolName, '. Each bullet should:\n- Start with "')
                .concat(
                  tool.toolName,
            ...
            return [
              4 /*yield*/,
              this.callGeminiWithFallback(prompt_7),
              // Nettoyer la réponse
            ];
          case 1:
        ...
        switch (_b.label) {
          case 0:
            ...
            crawledContent = crawledPages
              ...
              .join('\n\n');
            prompt_8 =
              'You are an expert at identifying target audiences for tools. Based on the crawled content below, identify the main target audiences for '
                .concat(tool.toolName, '.\n\nTool: ')
                .concat(tool.toolName, '\nCategory: ')
                .concat(tool.toolCategory || 'AI Tool', '\nURL: ')
                .concat(tool.toolLink, '\n\nContent from crawled pages:\n')
                ...
                .concat(
                  tool.toolName,
                  ' is particularly valuable for architects and designers who need to quickly visualize concepts and present ideas to clients. Video game developers can leverage its rapid rendering capabilities to create environmental mockups and prototype visual assets. Marketing professionals benefit from its ability to generate product visualizations for campaigns without expensive 3D software. Real estate developers find it useful for creating property visualizations and marketing materials from basic plans."\n\nTarget Audience:'
                );
            return [
              4 /*yield*/,
              this.callGeminiWithFallback(prompt_8),
              // Nettoyer la réponse
            ];
          case 1:
            audienceResponse = _b.sent();
            cleanAudience = audienceResponse
              .replace(/^Target Audience:?\s*/i, '')
              .trim();
            ...
            sentences = cleanAudience.split(/[.!?]+/).filter(function (s) {
              return s.trim().length > 0;
            });
            ...
            console.log(
              '\u2705 Target audience g\u00E9n\u00E9r\u00E9 avec succ\u00E8s'
            );
            return [2 /*return*/, cleanAudience];
          case 2:
            error_15 = _b.sent();
            console.error(
              '❌ Erreur génération target audience Gemini:',
              error_15.message
            );
            return [2 /*return*/, this.generateFallbackTargetAudience(tool)];
          case 3:
  ...
  ToolContentUpdaterService.generateFallbackUseCases = function (tool) {
    var _b;
    return '\u2022 '
      .concat(tool.toolName, ' helps you automate repetitive ')
      .concat(
        ((_b = tool.toolCategory) === null || _b === void 0
          ? void 0
          : _b.toLowerCase()) || 'digital',
        ' tasks\n\u2022 '
      )
  ...
  ToolContentUpdaterService.generateFallbackOverview = function (tool) {
    var _b;
    return ''
      .concat(tool.toolName, ' is an innovative AI tool designed for ')
      .concat(
        ((_b = tool.toolCategory) === null || _b === void 0
          ? void 0
          : _b.toLowerCase()) || 'various tasks',
        '. It provides automated solutions to streamline workflows and enhance productivity.'
      );
  };
  /**
  ...
  ToolContentUpdaterService.generateFallbackKeyFeatures = function (tool) {
    var _b;
    return '\u2022 Automate complex '.concat(
      ((_b = tool.toolCategory) === null || _b === void 0
        ? void 0
        : _b.toLowerCase()) || 'digital',
  ...
  ToolContentUpdaterService.generateFallbackMeta = function (tool) {
    ...
    return {
      metaTitle: ''
        .concat(tool.toolName, ' - ')
        .concat(tool.toolCategory || 'AI Tool', ' - Video-IA.net')
        .substring(0, 70),
      metaDescription: 'Discover '
        .concat(tool.toolName, ', a powerful ')
        .concat(
          ((_b = tool.toolCategory) === null || _b === void 0
            ? void 0
            : _b.toLowerCase()) || 'AI',
          ' tool. Learn features, use cases and get started today!'
        )
        .substring(0, 160),
    };
  };
  ...
  ToolContentUpdaterService.generateFallbackContent = function (tool) {
    ...
    return "## What's "
      ...
      .concat(
        tool.toolName,
        ' est un outil IA innovant qui transforme la fa\u00E7on dont nous abordons '
      )
      .concat(
        ((_b = tool.toolCategory) === null || _b === void 0
          ? void 0
          : _b.toLowerCase()) || 'les tâches numériques',
      ...
      .concat(
        tool.toolName,
        " r\u00E9side dans ses fonctionnalit\u00E9s avanc\u00E9es qui permettent aux utilisateurs de gagner un temps consid\u00E9rable. L'outil propose une gamme compl\u00E8te d'options personnalisables qui s'adaptent aux besoins sp\u00E9cifiques de chaque utilisateur, qu'il soit d\u00E9butant ou expert.\n\n## Pourquoi choisir "
      )
      .concat(tool.toolName, '?\n\nCe qui rend ')
      .concat(
        tool.toolName,
        " particuli\u00E8rement attrayant, c'est sa capacit\u00E9 \u00E0 simplifier des t\u00E2ches qui prendraient normalement des heures de travail manuel. Les utilisateurs appr\u00E9cient particuli\u00E8rement sa facilit\u00E9 d'int\u00E9gration avec d'autres outils existants et sa courbe d'apprentissage relativement douce.\n\n## Points d'attention\n\nCependant, comme tout outil, "
      )
      .concat(
        tool.toolName,
        " pr\u00E9sente certaines limitations qu'il convient de mentionner. L'outil peut parfois manquer de flexibilit\u00E9 pour des cas d'usage tr\u00E8s sp\u00E9cifiques, et ses fonctionnalit\u00E9s avanc\u00E9es n\u00E9cessitent parfois une p\u00E9riode d'adaptation pour \u00EAtre pleinement ma\u00EEtris\u00E9es.\n\n## Verdict final\n\nEn conclusion, "
      )
      .concat(
        tool.toolName,
        ' repr\u00E9sente un excellent choix pour quiconque cherche \u00E0 optimiser son workflow dans le domaine de '
      )
      .concat(
        ((_c = tool.toolCategory) === null || _c === void 0
          ? void 0
          : _c.toLowerCase()) || 'la technologie',
        ". Malgr\u00E9 quelques limitations mineures, ses avantages l'emportent largement sur ses inconv\u00E9nients, en faisant un investissement judicieux pour am\u00E9liorer sa productivit\u00E9."
      );
  };
  /**
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            error_16 = _b.sent();
            console.error(
              'Erreur lors du nettoyage de '.concat(tempDirPath, ':'),
              error_16
            );
            return [3 /*break*/, 3];
          case 3:
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              client_1.prisma.tool.findUnique({
                where: { id: toolId },
              }),
            ];
          case 2:
            ...
            if (!tool || !tool.toolLink) {
              (_b = result.errors) === null || _b === void 0
                ? void 0
                : _b.push('Outil non trouvé ou URL manquante');
              return [2 /*return*/, result];
            }
            result.toolName = tool.toolName;
            // Étape 1 : Vérification HTTP
            console.log(
              '\uD83D\uDD0D \u00C9tape 1: Test HTTP pour '.concat(tool.toolName, '...')
            );
          ...
          case 3:
            ...
            console.log(
              "\uD83D\uDCF8 \u00C9tape 1.5: Capture d'\u00E9cran pour ".concat(
                tool.toolName,
                '...'
              )
            );
          ...
          case 5:
            updatedTool = _d.sent();
            console.log(
              '\u2705 DB mise \u00E0 jour confirm\u00E9e via Prisma - imageUrl sauvegard\u00E9 pour Tool ID: '.concat(
                updatedTool.id
              )
            );
          ...
          case 6:
            console.log(
              '\uD83E\uDDEA Mode test: Screenshot cr\u00E9\u00E9 mais non sauvegard\u00E9 en DB'
            );
            console.log(
              '\uD83D\uDCF8 Screenshot cr\u00E9\u00E9: '.concat(screenshotPath)
            );
            _d.label = 7;
          case 7:
            return [3 /*break*/, 9];
          case 8:
            console.log(
              '\u274C \u00C9chec capture screenshot - imageUrl non mis \u00E0 jour'
            );
            _d.label = 9;
          case 9:
            // Étape 2 : Crawling
            ...
            console.log(
              '\uD83D\uDD77\uFE0F \u00C9tape 2: Crawling des pages pour '.concat(
                tool.toolName,
                '...'
              )
            );
          ...
          case 10:
            ...
            console.log(
              '\uD83C\uDF10 \u00C9tape 3: Extraction des r\u00E9seaux sociaux...'
            );
            return [
              4 /*yield*/,
              this.extractSocialLinks(crawlResult.crawledPages, tool),
            ];
          case 11:
            socialLinks = _d.sent();
          ...
          case 12:
            updatedTool = _d.sent();
            console.log(
              '\u2705 DB mise \u00E0 jour confirm\u00E9e via Prisma - Liens sociaux sauvegard\u00E9s pour Tool ID: '.concat(
                updatedTool.id
              )
            );
            return [3 /*break*/, 14];
          case 13:
            console.log(
              '\uD83E\uDDEA Mode test: Liens sociaux non sauvegard\u00E9s en DB'
            );
            _d.label = 14;
          case 14:
            ...
            return [
              4 /*yield*/,
              this.extractUsefulLinks(crawlResult.crawledPages, tool),
            ];
          case 15:
            usefulLinks = _d.sent();
          ...
          case 16:
            updatedTool = _d.sent();
            console.log(
              '\u2705 DB mise \u00E0 jour confirm\u00E9e via Prisma - Liens utiles sauvegard\u00E9s pour Tool ID: '.concat(
                updatedTool.id
              )
            );
            return [3 /*break*/, 18];
          case 17:
            console.log(
              '\uD83E\uDDEA Mode test: Liens utiles non sauvegard\u00E9s en DB'
            );
            _d.label = 18;
          case 18:
            ...
            console.log(
              '\u270D\uFE0F \u00C9tape 5: G\u00E9n\u00E9ration de contenu...'
            );
            return [
              4 /*yield*/,
              this.generateToolContent(tool, crawlResult.crawledPages),
            ];
          case 19:
            ...
            console.log(
              '\uD83D\uDCCA Mise \u00E0 jour DB: Description g\u00E9n\u00E9r\u00E9e ('.concat(
          ...
          case 20:
            updatedTool = _d.sent();
            console.log(
              '\u2705 DB mise \u00E0 jour confirm\u00E9e via Prisma - Description sauvegard\u00E9e pour Tool ID: '.concat(
                updatedTool.id
              )
            );
            console.log(
              '\uD83D\uDCDD Contenu: '.concat(generatedContent.substring(0, 100), '...')
            );
            return [3 /*break*/, 22];
          case 21:
            console.log(
              '\uD83E\uDDEA Mode test: Description g\u00E9n\u00E9r\u00E9e non sauvegard\u00E9e en DB'
            );
            console.log(
              '\uD83D\uDCDD Aper\u00E7u contenu: '.concat(
          ...
          case 22:
            ...
            return [
              4 /*yield*/,
              this.generateToolOverview(tool, crawlResult.crawledPages),
            ];
          case 23:
            ...
            console.log(
              '\uD83D\uDCCA Mise \u00E0 jour DB: Overview g\u00E9n\u00E9r\u00E9 ('.concat(
                generatedOverview.length,
                ' caract\u00E8res)'
              )
            );
            return [
          ...
          case 24:
            updatedTool = _d.sent();
            console.log(
              '\u2705 DB mise \u00E0 jour confirm\u00E9e via Prisma - Overview sauvegard\u00E9 pour Tool ID: '.concat(
                updatedTool.id
              )
            );
            return [3 /*break*/, 26];
          case 25:
            ...
            console.log(
              '\uD83D\uDCDD Aper\u00E7u overview: '.concat(generatedOverview)
            );
            _d.label = 26;
          case 26:
            ...
            return [
              4 /*yield*/,
              this.generateToolKeyFeatures(tool, crawlResult.crawledPages),
            ];
          case 27:
            ...
            console.log(
              '\uD83D\uDCCA Mise \u00E0 jour DB: Key features g\u00E9n\u00E9r\u00E9es'
            );
            return [
              4 /*yield*/,
              client_1.prisma.tool.update({
          ...
          case 28:
            updatedTool = _d.sent();
            console.log(
              '\u2705 DB mise \u00E0 jour confirm\u00E9e via Prisma - Key features sauvegard\u00E9es pour Tool ID: '.concat(
                updatedTool.id
              )
            );
            return [3 /*break*/, 30];
          case 29:
            console.log(
              '\uD83E\uDDEA Mode test: Key features non sauvegard\u00E9es en DB'
            );
            console.log(
              '\uD83D\uDCDD Aper\u00E7u key features: '.concat(
                generatedKeyFeatures.substring(0, 150),
                '...'
              )
            );
            _d.label = 30;
          case 30:
            ...
            console.log(
              '\uD83C\uDFF7\uFE0F \u00C9tape 8: G\u00E9n\u00E9ration des meta title et description...'
            );
          ...
          case 31:
            ...
            console.log(
              '\uD83D\uDCCA Mise \u00E0 jour DB: Meta title et description g\u00E9n\u00E9r\u00E9s'
            );
            return [
              4 /*yield*/,
              client_1.prisma.tool.update({
          ...
          case 32:
            updatedTool = _d.sent();
            console.log(
              '\u2705 DB mise \u00E0 jour confirm\u00E9e via Prisma - Meta donn\u00E9es sauvegard\u00E9es pour Tool ID: '.concat(
                updatedTool.id
              )
            );
            console.log('\uD83D\uDCDD Meta Title: '.concat(generatedMeta.metaTitle));
            console.log(
              '\uD83D\uDCDD Meta Description: '.concat(generatedMeta.metaDescription)
            );
            return [3 /*break*/, 34];
          case 33:
            console.log(
              '\uD83E\uDDEA Mode test: Meta donn\u00E9es non sauvegard\u00E9es en DB'
            );
            console.log('\uD83D\uDCDD Meta Title: '.concat(generatedMeta.metaTitle));
            console.log(
              '\uD83D\uDCDD Meta Description: '.concat(generatedMeta.metaDescription)
          ...
          case 34:
            ...
            return [
              4 /*yield*/,
              this.generateToolPricingModel(tool, crawlResult.crawledPages),
            ];
          case 35:
            ...
            console.log(
              '\uD83D\uDCCA Mise \u00E0 jour DB: Pricing model g\u00E9n\u00E9r\u00E9 ('.concat(
                generatedPricing,
                ')'
              )
            );
          ...
          case 36:
            updatedTool = _d.sent();
            console.log(
              '\u2705 DB mise \u00E0 jour confirm\u00E9e via Prisma - Pricing model sauvegard\u00E9 pour Tool ID: '.concat(
                updatedTool.id
              )
            );
          ...
          case 37:
            console.log(
              '\uD83E\uDDEA Mode test: Pricing model non sauvegard\u00E9 en DB'
            );
            console.log('\uD83D\uDCB0 Pricing Model: '.concat(generatedPricing));
            _d.label = 38;
          case 38:
            ...
            return [
              4 /*yield*/,
              this.generateToolUseCases(tool, crawlResult.crawledPages),
            ];
          case 39:
            ...
            console.log(
              '\uD83D\uDCCA Mise \u00E0 jour DB: Use cases g\u00E9n\u00E9r\u00E9s'
            );
            return [
              4 /*yield*/,
              client_1.prisma.tool.update({
          ...
          case 40:
            updatedTool = _d.sent();
            console.log(
              '\u2705 DB mise \u00E0 jour confirm\u00E9e via Prisma - Use cases sauvegard\u00E9s pour Tool ID: '.concat(
                updatedTool.id
              )
            );
            return [3 /*break*/, 42];
          case 41:
            ...
            console.log(
              '\uD83C\uDFAF Aper\u00E7u use cases: '.concat(
                generatedUseCases.substring(0, 150),
                '...'
              )
            );
            _d.label = 42;
          case 42:
            ...
            return [
              4 /*yield*/,
              this.generateToolTargetAudience(tool, crawlResult.crawledPages),
            ];
          case 43:
            ...
            console.log(
              '\uD83D\uDCCA Mise \u00E0 jour DB: Target audience g\u00E9n\u00E9r\u00E9'
            );
            return [
              4 /*yield*/,
              client_1.prisma.tool.update({
          ...
          case 44:
            updatedTool = _d.sent();
            console.log(
              '\u2705 DB mise \u00E0 jour confirm\u00E9e via Prisma - Target audience sauvegard\u00E9 pour Tool ID: '.concat(
                updatedTool.id
              )
            );
            console.log(
              '\uD83D\uDC65 Target Audience: '.concat(
                generatedTargetAudience.substring(0, 100),
                '...'
              )
            );
            return [3 /*break*/, 46];
          case 45:
            console.log(
              '\uD83E\uDDEA Mode test: Target audience non sauvegard\u00E9 en DB'
            );
            console.log(
              '\uD83D\uDC65 Aper\u00E7u target audience: '.concat(
                generatedTargetAudience.substring(0, 150),
                '...'
              )
            );
            _d.label = 46;
          ...
          case 47:
            ...
            console.log(
              '\u2705 Mise \u00E0 jour compl\u00E8te pour '.concat(
                tool.toolName,
                ' - 11 \u00E9tapes termin\u00E9es'
              )
            );
          ...
          case 48:
            error_17 = _d.sent();
            (_c = result.errors) === null || _c === void 0
              ? void 0
              : _c.push(error_17.message || 'Erreur inconnue');
            console.error(
              "\u274C Erreur lors de la mise \u00E0 jour de l'outil ".concat(
                toolId,
                ':'
              ),
              error_17
  ...
  ToolContentUpdaterService.ai = _a.GEMINI_API_KEY
    ? new genai_1.GoogleGenAI({ apiKey: _a.GEMINI_API_KEY })
    : null;
