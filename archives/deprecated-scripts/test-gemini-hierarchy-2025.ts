...
async function testGeminiHierarchy2025() {
  console.log('🧠 === TEST HIÉRARCHIE GEMINI 2025 - SYSTÈME DE RECOMMENCEMENT COMPLET ===\n')
  
  try {
    // 🔑 VÉRIFICATION DE LA CONFIGURATION
    if (!process.env.GEMINI_API_KEY) {
      console.error('❌ GEMINI_API_KEY non configurée')
      console.log('💡 Veuillez configurer votre clé API Gemini dans les variables d\'environnement')
      return
    }
